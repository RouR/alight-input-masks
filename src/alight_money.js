...
alight.d.al.money = {
  ...
  link: function(directiveScope, element, variable, env) {
    ...
    return self = {
      onDom: function() {
        alight.f$.on(element, 'input', self.updateModel);
        alight.f$.on(element, 'change', self.updateModel);
        directiveScope.$watch('$destroy', self.offDom);
      },
      offDom: function() {
        alight.f$.off(element, 'input', self.updateModel);
        alight.f$.off(element, 'change', self.updateModel);
      },
