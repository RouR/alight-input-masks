/**
 * Angular Light 0.12.12
 * (c) 2015 Oleg Nechaev
 * Released under the MIT License.
 * 2016-02-01, http://angularlight.org/ 
 */(function () {
     "use strict";
     function buildAlight() {
         ...
         (function () {
             var directives, keyCodes, makeEvent;
             ...
             alight.d.al.on = {
                 ...
                 init: function (scope, element, expression, env) {
                     ...
                     return handler(env.attrArgument, parts)(scope, element, expression, env);
                 }
             };
             keyCodes = {
                 enter: 13,
             ...
             makeEvent = function (event, option) {
                 option = option || {};
                 return function (code, args) {
                     var filter, filtered, i, k, len, prevent, ref, scan, stop;
